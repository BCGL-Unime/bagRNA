...
funannotate train -l "$C1_R1" "$C2_R1" "$C3_R1" "$T1_R1" "$T2_R1" "$T3_R1" -r "$C1_R2" "$C2_R2" "$C3_R2" "$T1_R2" "$T2_R2" "$T3_R2" --cpus 12 --out prv
...
bedtools intersect -b "$gff" -a complement_stringtie_trinity.gff -v -s > tmp1; cat tmp1 "$gff" > intersect_all.gff; rm tmp1
